      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
        {links.map(({ label, value, href, Icon }) => (
          <a
            ...
            rel="noreferrer"
            className="flex items-center gap-3 p-3 rounded-lg border border-transparent hover:border-border hover:bg-card transition-colors group"
          >
            <div className="w-8 h-8 rounded-md border border-border flex items-center justify-center flex-shrink-0 bg-background group-hover:border-foreground/20 transition-colors">
